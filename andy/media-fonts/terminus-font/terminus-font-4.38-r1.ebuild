...
IUSE="a-like-o +center-tilde distinct-l ru-dv +ru-g quote ru-i ru-k +psf raw-font-data +pcf +powerline"
...
src_prepare() {
	...
	use powerline && epatch "${FILESDIR}/${P}"-powerline-symbols.patch
}
